// - - - - - - - - - - - - - - - - - - -
// COMMENT N0: 1
// STUDENT NAME: AZAMAT SALAMATOV
// UNIVERSITY OF CINCINNNATI
// EECE 6029 - FALL 2024
// NOTE: MY COMMENTS ARE FORMATTED WITH DASHED LINES AND ARE ALL UPPERCASE
...
// - - - - - - - - - - - - - - - - - - -
// COMMENT NO: 2
// THE NEXT 14 LINES HAVE BEEN DUPLICATED IN THE
// ORIGINAL CODE ON CANVAS. I HAVE REMOVED THE SECOND DUPLICATE.
// - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - -
// COMMENT NO: 3
// ADDED COUNTER TO TRACK NUMBER OF PRINTS
// - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - -
// COMMENT NO: 4
// CHECK IF WE HAVE ALREADY PRINTED 10 TIMES
// IF YES, THEN STOP THIS FUNCTION AND RETURN 0
// - - - - - - - - - - - - - - - - - - -
        if (print_count >= 10) return 0;
...
// - - - - - - - - - - - - - - - - - - -
// COMMENT NO: 5
// INCREMENT THE PRINT COUNTER AFTER THE MESSAGE IS PRINTED
// HOW DO I KNOW THE MESSAGE IS PRINTED?
//   - WHEN MSG_PTR REACHES THE END OF MSG_BUFFER,
//     I KNOW THAT THE ENTIRE MESSAGE HAS BEEN TRANSFERED
//     FROM KERNEL BUFFER TO USER BUFFER. THIS IS EXACTLY
//     WHEN THE LOOP FINISHES. SO THE MESSAGE IS PRINTED
//     ONCE TO THE USER. SO AFTER THIS LOOP FINISHES SUCCESSFULLY,
//     I WILL HAVE BYTES_READ VARIABLE GREATER THAN 0.
// - - - - - - - - - - - - - - - - - - -
	if (bytes_read > 0) print_count++;
...
// - - - - - - - - - - - - - - - - - - -
// COMMENT NO: 6
// RESET THE PRINT COUNTER WHEN THE DEVICE IS REOPENED
// - - - - - - - - - - - - - - - - - - -
     print_count = 0;
